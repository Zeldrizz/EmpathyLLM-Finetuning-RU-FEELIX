...
Идея проекта возникла из потребности в аналогах современных закрытых LLM, таких как **ChatGPT** и **YandexGPT**, которые могли бы не просто генерировать текст, а эффективно справляться с задачей **эмпатичного общения и поддержки**. Главной целью было создать **легковесную** LLM, которая не уступала бы по качеству существующим моделям, но была бы **специализирована** именно на эмоциональной поддержке.  
...
3. **Дообучение моделей (fine-tuning) на суперкомпьютере**  
   - Все эксперименты по обучению проводились на **суперкомпьютере** Высшей школы экономики.  
...
### Благодарность  
Огромная благодарность **НИУ ВШЭ** за предоставленный доступ к **суперкомпьютеру**, благодаря которому стало возможным выполнение всех fine-tune.  
