...
new_model = "llama-3.1-8b-it-Emotional-Psychology-Support-ChatBot-RU"

train_dataset_path = "/home/mrtaktarov/FEELIX_bot/datasets/psychology_dataset_ru/psychology_dataset_ru_train_90_90.csv"
valid_dataset_path = "/home/mrtaktarov/FEELIX_bot/datasets/psychology_dataset_ru/psychology_dataset_ru_valid_90_10.csv"
...
- При возникновении конфликтных тем (например, религия, политика) мягко перенаправляй разговор: "Давай поговорим о чём-то другом, что волнует тебя."
