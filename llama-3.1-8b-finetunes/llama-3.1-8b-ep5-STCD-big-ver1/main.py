...
dataset_name = "/home/mrtaktarov/FEELIX_bot/datasets/STCD_big_ver1.csv"
...
train_dataset = train_dataset.map(format_chat_template, num_proc=8)
test_dataset = test_dataset.map(format_chat_template, num_proc=8)
